...
function _templateObject() {
  var data = _taggedTemplateLiteral(["<Layout::NavBar />"]);
...
(0, _qunit.module)('Integration | Component | layout/nav-bar', function (hooks) {
    ...
    return regeneratorRuntime.async(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            component = this.element.querySelector('.navbar');
